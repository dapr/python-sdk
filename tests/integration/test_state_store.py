...
def test_save_with_wrong_etag_fails(client):
...
def test_save_and_get_bulk(client):
...
def test_save_bulk_with_wrong_etag_fails(client):
...
def test_transaction_upsert(client):
