...
version_info = {}
with open('dapr/ext/crewai/version.py') as fp:
...
name = 'dapr-ext-crewai'
version = __version__
description = 'The official release of Dapr Python SDK CrewAI Extension.'
long_description = """
...
CrewAI is a framework for orchestrating role-playing, autonomous AI agents that work
...
if not is_release():
    ...
    description = 'The developmental release for the Dapr Workflow extension for CrewAI'
    long_description = (
        'This is the developmental release for the Dapr Workflow extension for CrewAI'
    )
