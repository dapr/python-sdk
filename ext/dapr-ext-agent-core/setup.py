...
version_info = {}
with open('dapr/ext/agent_core/version.py') as fp:
...
name = 'dapr-ext-agent_core'
version = __version__
description = 'The official release of Dapr Python SDK Agent Core Extension.'
long_description = """
This is the core extension for Dapr Python SDK Agent integrations.
