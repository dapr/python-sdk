...
if not is_release():
    ...
    setup_kwargs['description'] = 'The developmental release for Dapr Workflow Authoring.'
    setup_kwargs['long_description'] = (
        'This is the developmental release for Dapr Workflow Authoring.'
    )
    setup_kwargs['install_requires'] = [
        'dapr-dev' + r[4:] if r.startswith('dapr ') else r for r in stable_requires
    ]
