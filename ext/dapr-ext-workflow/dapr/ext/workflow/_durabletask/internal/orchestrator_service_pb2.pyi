...
class OrchestratorRequest(_message.Message):
    ...
    def __init__(
        ...
        pastEvents: _Optional[_Iterable[_Union[_history_events_pb2.HistoryEvent, _Mapping]]] = ...,
        newEvents: _Optional[_Iterable[_Union[_history_events_pb2.HistoryEvent, _Mapping]]] = ...,
        requiresHistoryStreaming: bool = ...,
...
class OrchestratorResponse(_message.Message):
    ...
    actions: _containers.RepeatedCompositeFieldContainer[
        _orchestrator_actions_pb2.OrchestratorAction
    ]
    ...
    def __init__(
        ...
        instanceId: _Optional[str] = ...,
        actions: _Optional[
            _Iterable[_Union[_orchestrator_actions_pb2.OrchestratorAction, _Mapping]]
        ] = ...,
        customStatus: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...,
        completionToken: _Optional[str] = ...,
        numEventsProcessed: _Optional[_Union[_wrappers_pb2.Int32Value, _Mapping]] = ...,
        version: _Optional[_Union[_orchestration_pb2.OrchestrationVersion, _Mapping]] = ...,
    ) -> None: ...
...
class CreateInstanceRequest(_message.Message):
    ...
    def __init__(
        ...
        orchestrationIdReusePolicy: _Optional[
            _Union[_orchestration_pb2.OrchestrationIdReusePolicy, _Mapping]
        ] = ...,
        executionId: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...,
...
class GetInstanceRequest(_message.Message):
    ...
    def __init__(
        self, instanceId: _Optional[str] = ..., getInputsAndOutputs: bool = ...
    ) -> None: ...
...
class GetInstanceResponse(_message.Message):
    ...
    def __init__(
        self,
        exists: bool = ...,
        orchestrationState: _Optional[
            _Union[_orchestration_pb2.OrchestrationState, _Mapping]
        ] = ...,
    ) -> None: ...
...
class PurgeInstancesRequest(_message.Message):
    ...
    def __init__(
        self,
        instanceId: _Optional[str] = ...,
        purgeInstanceFilter: _Optional[_Union[PurgeInstanceFilter, _Mapping]] = ...,
        recursive: bool = ...,
        force: bool = ...,
    ) -> None: ...
...
class PurgeInstanceFilter(_message.Message):
    ...
    def __init__(
        self,
        createdTimeFrom: _Optional[
            _Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]
        ] = ...,
        createdTimeTo: _Optional[
            _Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]
        ] = ...,
        runtimeStatus: _Optional[
            _Iterable[_Union[_orchestration_pb2.OrchestrationStatus, str]]
        ] = ...,
    ) -> None: ...
...
class PurgeInstancesResponse(_message.Message):
    ...
    def __init__(
        self,
        deletedInstanceCount: _Optional[int] = ...,
        isComplete: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ...,
    ) -> None: ...
...
class WorkItem(_message.Message):
    ...
    def __init__(
        self,
        orchestratorRequest: _Optional[_Union[OrchestratorRequest, _Mapping]] = ...,
        activityRequest: _Optional[_Union[ActivityRequest, _Mapping]] = ...,
        completionToken: _Optional[str] = ...,
    ) -> None: ...
...
class RerunWorkflowFromEventRequest(_message.Message):
    ...
    def __init__(
        self,
        sourceInstanceID: _Optional[str] = ...,
        eventID: _Optional[int] = ...,
        newInstanceID: _Optional[str] = ...,
        input: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...,
        overwriteInput: bool = ...,
        newChildWorkflowInstanceID: _Optional[str] = ...,
    ) -> None: ...
...
class ListInstanceIDsRequest(_message.Message):
    ...
    pageSize: int
    def __init__(
        self, continuationToken: _Optional[str] = ..., pageSize: _Optional[int] = ...
    ) -> None: ...
...
class ListInstanceIDsResponse(_message.Message):
    ...
    continuationToken: str
    def __init__(
        self, instanceIds: _Optional[_Iterable[str]] = ..., continuationToken: _Optional[str] = ...
    ) -> None: ...
...
class GetInstanceHistoryResponse(_message.Message):
    ...
    def __init__(
        self, events: _Optional[_Iterable[_Union[_history_events_pb2.HistoryEvent, _Mapping]]] = ...
    ) -> None: ...
