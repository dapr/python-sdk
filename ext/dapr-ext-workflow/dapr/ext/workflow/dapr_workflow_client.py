...
class DaprWorkflowClient:
    """Defines client operations for managing Dapr Workflow instances.
       ...
       This client is intended to be used by workflow applications, not by general purpose applications.
    """
    ...
    def schedule_new_workflow(self, workflow: Workflow, *,
        ...
        Args:
            ...
            input: The optional input to pass to the scheduled workflow instance. This must be a serializable value.
            instance_id: The unique ID of the workflow instance to schedule. If not specified, a new GUID value is used.
            start_at: The time when the workflow instance should start executing. If not specified or if a date-time in the past is specified, the workflow instance will be scheduled immediately.
    ...
    def get_workflow_state(self, instance_id: str, *,
        ...
        Args:
            ...
            fetch_payloads: If true, fetches the input, output payloads and custom status for the workflow instance.
            Defaults to false.
    ...
    def wait_for_workflow_start(self, instance_id: str, *,
        ...
        """Waits for a workflow to start running and returns a WorkflowState object that contains metadata
           about the started workflow.
           
           A "started" workflow instance is any instance not in the WorkflowRuntimeStatus.Pending state.
           ...
           Args:
                ...
                fetch_payloads: If true, fetches the input, output payloads and custom status for the workflow instance.
                                Defaults to false.
                timeout: The maximum time to wait for the workflow instance to start running. Defaults to 60 seconds.
    ...
    def wait_for_workflow_completion(self, instance_id: str, *,
                                     ...
                                     timeout: int = 60) -> Union[WorkflowState, None]:
        """
        Waits for a workflow to complete and returns a WorkflowState object that contains metadata
        about the started instance.
        
        A "completed" workflow instance is any instance in one of the terminal states. For example, the
        WorkflowRuntimeStatus.Completed, WorkflowRuntimeStatus.Failed or
        ...
        enforced using timeout parameter.
        ...
        Args:
            ...
            fetch_payloads: If true, fetches the input, output payloads and custom status for the workflow instance.
                            Defaults to true.
            timeout: The maximum time to wait for the workflow instance to complete. Defaults to 60 seconds.
    ...
    def raise_workflow_event(self, instance_id: str, event_name: str, *,
        ...
        If the target workflow instance is not yet waiting for an event named param "eventName" value,
        then the event will be saved in the workflow instance state and dispatched immediately when the
        workflow calls wait_for_external_event.
        ...
        wait_for_external_event method.
    ...
    def terminate_workflow(self, instance_id: str, *,
        ...
        """Terminates a running workflow instance and updates its runtime status to WorkflowRuntimeStatus.Terminated
        This method internally enqueues a "terminate" message in the task hub. When the task hub worker processes
        this message, it will update the runtime status of the target instance to WorkflowRuntimeStatus.Terminated.
        You can use wait_for_workflow_completion to wait for the instance to reach the terminated state.
