...
class ConversationRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_contextID", b"_contextID", "_scrubPII", b"_scrubPII", "_temperature", b"_temperature", "contextID", b"contextID", "inputs", b"inputs", "metadata", b"metadata", "name", b"name", "parameters", b"parameters", "scrubPII", b"scrubPII", "temperature", b"temperature", "tools", b"tools"]) -> None: ...
    @typing.overload
...
class ConversationInput(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        scrubPII: builtins.bool | None = ...,
        parts: collections.abc.Iterable[global___ContentPart] | None = ...,
    ) -> None: ...
    ...
    def ClearField(self, field_name: typing.Literal["_role", b"_role", "_scrubPII", b"_scrubPII", "content", b"content", "parts", b"parts", "role", b"role", "scrubPII", b"scrubPII"]) -> None: ...
    @typing.overload
...
class ContentPart(google.protobuf.message.Message):
    ...
    TOOL_RESULT_FIELD_NUMBER: builtins.int
    @property
    def text(self) -> global___TextContent: ...
    @property
    def tool_call(self) -> global___ToolCallContent: ...
    @property
    def tool_result(self) -> global___ToolResultContent:
        """Future: ImageContent image = 4;
        Future: DocumentContent document = 5;
        """
    ...
    def __init__(
        ...
        *,
        ...
        tool_call: global___ToolCallContent | None = ...,
        tool_result: global___ToolResultContent | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["content_type", b"content_type", "text", b"text", "tool_call", b"tool_call", "tool_result", b"tool_result"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["content_type", b"content_type", "text", b"text", "tool_call", b"tool_call", "tool_result", b"tool_result"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["content_type", b"content_type"]) -> typing.Literal["text", "tool_call", "tool_result"] | None: ...
...
@typing.final
class ToolCallContent(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["arguments", b"arguments", "id", b"id", "name", b"name", "type", b"type"]) -> None: ...

global___ToolCallContent = ToolCallContent

@typing.final
class ToolResultContent(google.protobuf.message.Message):
    ...
    """Indicates tool execution error"""
    def __init__(
        self,
        *,
        tool_call_id: builtins.str = ...,
        name: builtins.str = ...,
        content: builtins.str = ...,
        is_error: builtins.bool | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["_is_error", b"_is_error", "is_error", b"is_error"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_is_error", b"_is_error", "content", b"content", "is_error", b"is_error", "name", b"name", "tool_call_id", b"tool_call_id"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["_is_error", b"_is_error"]) -> typing.Literal["is_error"] | None: ...

global___ToolResultContent = ToolResultContent
...
class ConversationResult(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_finish_reason", b"_finish_reason", "finish_reason", b"finish_reason", "parameters", b"parameters", "parts", b"parts", "result", b"result"]) -> None: ...
...
class ConversationResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_contextID", b"_contextID", "_usage", b"_usage", "contextID", b"contextID", "outputs", b"outputs", "usage", b"usage"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_contextID", b"_contextID"]) -> typing.Literal["contextID"] | None: ...
    @typing.overload
...
class ConversationStreamChunk(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        is_delta: builtins.bool | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["_chunk_index", b"_chunk_index", "_finish_reason", b"_finish_reason", "_is_delta", b"_is_delta", "chunk_index", b"chunk_index", "finish_reason", b"finish_reason", "is_delta", b"is_delta"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_chunk_index", b"_chunk_index", "_finish_reason", b"_finish_reason", "_is_delta", b"_is_delta", "chunk_index", b"chunk_index", "finish_reason", b"finish_reason", "is_delta", b"is_delta", "parts", b"parts"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_chunk_index", b"_chunk_index"]) -> typing.Literal["chunk_index"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_finish_reason", b"_finish_reason"]) -> typing.Literal["finish_reason"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_is_delta", b"_is_delta"]) -> typing.Literal["is_delta"] | None: ...
...
class Tool(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["description", b"description", "name", b"name", "parameters", b"parameters", "type", b"type"]) -> None: ...
