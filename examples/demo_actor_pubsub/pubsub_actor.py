...
from pubsub_actor_interface import DemoActorInterface
...
class DemoActor(Actor, DemoActorInterface, Remindable):
    ...
    async def mymethod1(self, data) -> None:
        print("Method called with pubsub")
        print(f'Data received: {data}')
    
    async def mymethod2(self, data) -> None:
        print("This is another method called with pubsub for Actor: Demo Actor")
        print(f'Data received: {data}')
...
class AnotherActor(Actor, DemoActorInterface, Remindable):
    """Implements DemoActor actor service
    ...
    def __init__(self, ctx, actor_id):
        super(AnotherActor, self).__init__(ctx, actor_id)
    ...
    async def mymethod2(self, data) -> None:
        print("This is another method called with pubsub for Actor: AnotherActor")
        print(f'Data received: {data}')
